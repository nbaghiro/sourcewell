...
The deterministic scoring + the `Candidate` protocol live in the kernel's `app/targeting.py` (the
single source of truth, mirrored byte-for-byte by the frontend). This module keeps only the async,
