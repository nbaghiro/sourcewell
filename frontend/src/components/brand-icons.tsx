...
export function MicrosoftIcon({ className = "size-[15px]" }: { className?: string }) {
  return (
...
/** Email ↔ LinkedIn channel icon. */
export function ChannelIcon({ channel, className }: { channel: string; className?: string }) {
  return channel === "linkedin" ? <LinkedInIcon className={className} /> : <Mail className={className} />;
}
